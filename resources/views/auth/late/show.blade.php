...
<div class="cnt-position">
    <div class="cnt-width cnt-mg-top auth-flame">
        ...
        <div class="flex auth-form show-form">
                ...
                <!-- 遅刻日 -->
                <div class="auth-input flex">
                    <label for="absentDay" value="absentDay">遅刻日</label>
                    <p class="input-css show-input">{{ $late->day }}</p>
                </div>
                <!-- 到着時間 -->
                <div class="auth-input flex">
                    <label for="absentDay" value="absentDay">到着時間</label>
                    <p class="input-css show-input">{{ $late->time }}</p>
                </div>
                <!-- 送迎者 -->
                <div class="auth-input flex">
                    <label for="absentDay" value="absentDay">送迎者</label>
                    <p class="input-css show-input">{{ $late->parent }}</p>
                </div>
