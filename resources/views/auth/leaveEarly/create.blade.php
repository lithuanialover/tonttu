    ...
    <div class="cnt-width cnt-mg-top">
        <div class="cnt-mg-top auth-flame">
            ...
            <div class="flex auth-form">
                <form method="post" action="{{ route('leaveearlys.store') }}" enctype="multipart/form-data">
                    @csrf
                    <!-- 園児：名前 -->
